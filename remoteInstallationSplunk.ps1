...
{ 
   ...
   $destPath = ("\\$server\rm")
    ...
    {    
        ...
        $args = { & cmd /c "msiexec.exe /i D:\rm\UniForwarding.msi" /qn AGREETOLICENSE=Yes DEPLOYMENT_SERVER=$DEPLOYMENT_SERVER RECEIVING_INDEXER=$INDEXER_IP /log D:\rm\MSI_Install.log /quiet}
